...
save_file = 'C:\Users\isaac\Documents\writeupfigs\'; % Place to save figures
...
% k6 = 0.11;
% k7 = 0.035;
% k7 = 0;%value in linear degradation 
% B_cont = 80;
% k8 = 0.066;
% k8 = 0;
% alpha = 2.7*10^(-3);
...
t = 0:0.01:24;
sol = ode15s(@ODE_model, [0 24], y_0, [], P1{:},V_medium);
h = deval(sol,t);
Cn = 1;
Cn = 0;
figure(2)
...
file_name = [save_file 'odeuptake.eps'];
...
for j = 1:3
    for i = 1:21 
        ...
        sol = ode15s(@ODE_model, [0 2], y_0, [], P1{:},V_medium);
        g = deval(sol,2);
...
file_name = [save_file 'odevol.eps'];
...
sol = ode15s(@ODE_model, [0 2], y_0, [], P1{:}, k_cellnumber,gamma,Cn,V_medium);
h = deval(sol,2);
washout_mod(i) = (h(2)+h(3)+h(4))/1000;
y_1 = [h(1) h(2) h(3) h(4) 0 0 h(7) h(8) h(9)];
sol1 = ode15s(@ODE_model, [0 8], y_1, [], P1{:}, k_cellnumber,gamma,Cn,V_medium);
g = deval(sol1, 8);
...
sol1 = ode15s(@ODE_model, [0 8], y_1, [], P1{:},V_medium);
g = deval(sol1, 8);
eq_mod(i) = (g(2)+g(3)+g(4))/1000;
end
...
y_1 = [h(1) h(2) h(3) h(4) 0 0 h(7) h(8) h(9)];
sol1 = ode15s(@ODE_model, [0 24], y_1, [], P1{:}, k_cellnumber,gamma,Cn,V_medium);
t = 0.01:0.01:24;
v = deval(sol1, t);
...
sol1 = ode15s(@ODE_model, [0 24], y_0, [], P1{:}, k_cellnumber,gamma,Cn,V_medium);
g = deval(sol1,t);
